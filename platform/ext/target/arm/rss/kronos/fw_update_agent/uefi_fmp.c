...
static uint16_t kronos_image_name0[] = { 'K', 'R', 'O', 'N', 'O', 'S', '\0' };
static uint16_t kronos_version_name0[] = { 'K', 'R', 'O', 'N', 'O', 'S', '\0'};
...
static void init_fmp_info(void)
{
    ...
    fmp_info[0].DescriptorsSize =
                 ...
                 sizeof(kronos_image_name0) + sizeof(kronos_version_name0);
    ...
    fmp_info[0].ImageName = kronos_image_name0;
    fmp_info[0].ImageNameSize = sizeof(kronos_image_name0);
    fmp_info[0].ImageVersionName = kronos_version_name0;
    fmp_info[0].ImageVersionNameSize = sizeof(kronos_version_name0);
