...
/* Postbox Doorbell Channel Window Page <n>, where n is 0 - 127 */
...
/* Mailbox Doorbell Channel Window Page <n>, where n is 0 - 127 */
...
enum mhu_v3_x_error_t mhu_v3_x_doorbell_mask_set(
     const struct mhu_v3_x_dev_t *dev, uint32_t channel, uint32_t mask)
{
    union _mhu_v3_x_frame_t *p_mhu;
    struct _mhu_v3_x_mbx_mdbcw_reg_t *mdbcw_reg;
    enum mhu_v3_x_error_t status;
    ...
    /* Doorbell channel mask in not applicable for PBX */
    if(dev->frame != MHU_V3_X_MBX_FRAME) {
        return MHU_V_3_X_ERR_INVALID_PARAM;
    }
...
enum mhu_v3_x_error_t mhu_v3_x_doorbell_mask_get(
     const struct mhu_v3_x_dev_t *dev, uint32_t channel, uint32_t *mask_status)
{
    union _mhu_v3_x_frame_t *p_mhu;
    struct _mhu_v3_x_mbx_mdbcw_reg_t *mdbcw_reg;
    enum mhu_v3_x_error_t status;
...
void _mhu_v3_x_doorbell_interrupt_enable(
...
void _mhu_v3_x_doorbell_interrupt_disable(
     const struct mhu_v3_x_dev_t *dev, uint32_t channel)
{
    union _mhu_v3_x_frame_t *p_mhu;
...
void _mhu_v3_x_doorbell_interrupt_clear(
     const struct mhu_v3_x_dev_t *dev, uint32_t channel)
{
    union _mhu_v3_x_frame_t *p_mhu;
    struct _mhu_v3_x_pbx_pdbcw_reg_t *pdbcw_reg;
...
enum mhu_v3_x_error_t mhu_v3_x_channel_interrupt_clear(
     ...
     enum mhu_v3_x_channel_type_t ch_type)
{
    union _mhu_v3_x_frame_t *p_mhu = (union _mhu_v3_x_frame_t *)dev->base;
    enum mhu_v3_x_error_t status;
