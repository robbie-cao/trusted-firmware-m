...
/* BL1 data is in DTCM */
#define BL1_1_DATA_START  (BOOT_TFM_SHARED_DATA_BASE + BOOT_TFM_SHARED_DATA_SIZE - SHARED_OFFSET)
#define BL1_1_DATA_SIZE   ((DTCM_SIZE - BOOT_TFM_SHARED_DATA_SIZE + SHARED_OFFSET) / 2)
#define BL1_1_DATA_LIMIT  (BL1_1_DATA_START + BL1_1_DATA_SIZE - 1)

#define BL1_2_DATA_START  (BL1_1_DATA_START + BL1_1_DATA_SIZE)
#define BL1_2_DATA_SIZE   ((DTCM_SIZE - BOOT_TFM_SHARED_DATA_SIZE + SHARED_OFFSET) / 2)
...
#define BL2_DATA_SIZE     (DTCM_SIZE - BOOT_TFM_SHARED_DATA_SIZE + SHARED_OFFSET)
#define BL2_DATA_LIMIT    (BL2_DATA_START + BL2_DATA_SIZE - 1)

/* Store boot data at the start of the DTCM. */
#define BOOT_TFM_SHARED_DATA_BASE DTCM_BASE_S
#define BOOT_TFM_SHARED_DATA_SIZE (0x400 + SHARED_OFFSET)
#define BOOT_TFM_SHARED_DATA_LIMIT (BOOT_TFM_SHARED_DATA_BASE + \
                                    BOOT_TFM_SHARED_DATA_SIZE - SHARED_OFFSET - 1)
#define SHARED_OFFSET 0x400
